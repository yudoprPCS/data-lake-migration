"""Analyze POSe dependency graph: parse CSV, rank by children count, generate visual graph."""
...
CSV_PATH = os.path.join(SCRIPT_DIR, "Migrations Plan - ELK & PostgreSQL POSe.csv")
GRAPH_PNG = os.path.join(SCRIPT_DIR, "pose_dependency_graph.png")
MERMAID_MD = os.path.join(SCRIPT_DIR, "pose_dependency_graph.md")
...
def generate_graph_png(G, output_path):
    ...
    ax.set_title('POSe ELK & PostgreSQL -> Data Lake Dependency Graph\n(Node size = migration priority / dependents count)',
