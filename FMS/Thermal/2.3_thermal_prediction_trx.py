...
if __name__ == "__main__":
    ...
    get_global_trend(global_param="transaction_count")

    grand_loop(
        global_param="transaction_count",
        specify_path=args.specify_path,
        step_start=args.step_start
    )

# grand_loop(global_param="transaction_count")

# grand_loop(global_param="transaction_count", step_start=1, specify_path="thermal_paper_lte_20251218_sum_area_20260101_to_20260131")
